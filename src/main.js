...
import { getUsableHeightPx, PAGE_MARGIN_MM, PAGE_MARGIN_MM_EVERY_PAGE } from './pageGuide.js';
import {
...
function applyLogoBranding() {
  ...
  if (showLogo && logoCol && el.brandLogoHeaderImg) {
    /* Scale = max width of shrink-wrap column; img keeps intrinsic aspect (object-contain). */
